...
x=np.load('./DATA__norm_0_1.npy', allow_pickle=True)
x_exp=np.load('./DATA__norm_3_1.npy', allow_pickle=True)
x_sinh=np.load('./DATA__norm_10_1_correct.npy', allow_pickle=True)
# with open('out_latent.csv', 'w') as f:
#     for key in DATA_a_non.keys():
#         f.write("%s,%s\n"%(key,DATA_a_non[key]))

out_mse_h = {'norm(0,1)':x.tolist()['mse_h'], 'norm(0,3)':x_exp.tolist()['mse_h'],'norm(0,10)':x_sinh.tolist()['mse_h']}
...
out_mse_l1 = {'norm(0,1)':x.tolist()['mse_l1'], 'norm(0,3)':x_exp.tolist()['mse_l1'],'norm(0,10)':x_sinh.tolist()['mse_l1']}
plt.figure(figsize=(8, 6))
...
out_mse_l2 = {'norm(0,1)':x.tolist()['mse_l2'], 'norm(0,3)':x_exp.tolist()['mse_l2'],'norm(0,10)':x_sinh.tolist()['mse_l2']}
plt.figure(figsize=(8, 6))
...
out_mse_l3 = {'norm(0,1)':x.tolist()['mse_l3'], 'norm(0,3)':x_exp.tolist()['mse_l3'],'norm(0,10)':x_sinh.tolist()['mse_l3']}
plt.figure(figsize=(8, 6))
...
out_opt_history = {'norm(0,1)':x.tolist()['out_opt_history'], 'norm(0,3)':x_exp.tolist()['out_opt_history'],'norm(0,10)':x_sinh.tolist()['out_opt_history']}
plt.figure(figsize=(8, 6))
...
out_omega_1 = {'norm(0,1)':x.tolist()['omega_1'], 'norm(0,3)':x_exp.tolist()['omega_1'],'norm(0,10)':x_sinh.tolist()['omega_1']}
plt.figure(figsize=(8, 6))
...
out_omega_2 = {'norm(0,1)':x.tolist()['omega_2'], 'norm(0,3)':x_exp.tolist()['omega_2'],'norm(0,10)':x_sinh.tolist()['omega_2']}
plt.figure(figsize=(8, 6))
...
out_omega_3 = {'norm(0,1)':x.tolist()['omega_3'], 'norm(0,3)':x_exp.tolist()['omega_3'],'norm(0,10)':x_sinh.tolist()['omega_3']}
plt.figure(figsize=(8, 6))
...
out_omega_4 = {'norm(0,1)':x.tolist()['omega_4'], 'norm(0,3)':x_exp.tolist()['omega_4'],'norm(0,10)':x_sinh.tolist()['omega_4']}
plt.figure(figsize=(8, 6))
...
out_omega_5 = {'norm(0,1)':x.tolist()['omega_5'], 'norm(0,3)':x_exp.tolist()['omega_5'],'norm(0,10)':x_sinh.tolist()['omega_5']}
plt.figure(figsize=(8, 6))
...
out_omega_6 = {'norm(0,1)':x.tolist()['omega_6'], 'norm(0,3)':x_exp.tolist()['omega_6'],'norm(0,10)':x_sinh.tolist()['omega_6']}
plt.figure(figsize=(8, 6))
...
out_omega_7 = {'norm(0,1)':x.tolist()['omega_7'], 'norm(0,3)':x_exp.tolist()['omega_7'],'norm(0,10)':x_sinh.tolist()['omega_7']}
plt.figure(figsize=(8, 6))
...
out_omega_8 = {'norm(0,1)':x.tolist()['omega_8'], 'norm(0,3)':x_exp.tolist()['omega_8'],'norm(0,10)':x_sinh.tolist()['omega_8']}
plt.figure(figsize=(8, 6))
...
out_omega_9 = {'norm(0,1)':x.tolist()['omega_9'], 'norm(0,3)':x_exp.tolist()['omega_9'],'norm(0,10)':x_sinh.tolist()['omega_9']}
plt.figure(figsize=(8, 6))
...
out_omega_10 = {'norm(0,1)':x.tolist()['omega_10'], 'norm(0,3)':x_exp.tolist()['omega_10'],'norm(0,10)':x_sinh.tolist()['omega_10']}
plt.figure(figsize=(8, 6))
...
out_a_1 = {'norm(0,1)':x.tolist()['a_1'], 'norm(0,3)':x_exp.tolist()['a_1'],'norm(0,10)':x_sinh.tolist()['a_1']}
plt.figure(figsize=(8, 6))
...
out_a_2 = {'norm(0,1)':x.tolist()['a_2'], 'norm(0,3)':x_exp.tolist()['a_2'],'norm(0,10)':x_sinh.tolist()['a_2']}
plt.figure(figsize=(8, 6))
...
out_a_3 = {'norm(0,1)':x.tolist()['a_3'], 'norm(0,3)':x_exp.tolist()['a_3'],'norm(0,10)':x_sinh.tolist()['a_3']}
plt.figure(figsize=(8, 6))
...
out_a_4 = {'norm(0,1)':x.tolist()['a_4'], 'norm(0,3)':x_exp.tolist()['a_4'],'norm(0,10)':x_sinh.tolist()['a_4']}
plt.figure(figsize=(8, 6))
...
out_a_5 = {'norm(0,1)':x.tolist()['a_5'], 'norm(0,3)':x_exp.tolist()['a_5'],'norm(0,10)':x_sinh.tolist()['a_5']}
plt.figure(figsize=(8, 6))
...
out_a_6 = {'norm(0,1)':x.tolist()['a_6'], 'norm(0,3)':x_exp.tolist()['a_6'],'norm(0,10)':x_sinh.tolist()['a_6']}
plt.figure(figsize=(8, 6))
...
out_a_7 = {'norm(0,1)':x.tolist()['a_7'], 'norm(0,3)':x_exp.tolist()['a_7'],'norm(0,10)':x_sinh.tolist()['a_7']}
plt.figure(figsize=(8, 6))
...
out_a_8 = {'norm(0,1)':x.tolist()['a_8'], 'norm(0,3)':x_exp.tolist()['a_8'],'norm(0,10)':x_sinh.tolist()['a_8']}
plt.figure(figsize=(8, 6))
